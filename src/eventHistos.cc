...
//THIS FLAVOR IS FOR THE STREAMLINED ANALYSIS.  IT ONLY CONTAINS PLOTS NECESSARY FOR THE FINAL ANALYSIS
    ...
    m_eventsWeight = m_histoFolder.make<TH1D>("eventsWeight","number of events weighted", 1, 0.0, 1);
    m_leadAK8JetMuonMass      =           m_histoFolder.make<TH1D>("leadAK8JetMuonMass","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_JECUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_JECUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_JECDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_JECDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_JERUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_JERUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_JERDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_JERDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_PUUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_PUUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_PUDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_PUDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuIDUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuIDUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuIDDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuIDDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuLUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuLUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuLDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuLDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuIsoUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuIsoUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuIsoDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuIsoDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuTrigUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuTrigUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuTrigDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuTrigDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuResolUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuResolUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_MuResolDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_MuResolDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF      =           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_JECUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_JECUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_JECDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_JECDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_JERUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_JERUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_JERDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_JERDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_PUUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_PUUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_PUDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_PUDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuIDUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuIDUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuIDDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuIDDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuLUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuLUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuLDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuLDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuIsoUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuIsoUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuIsoDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuIsoDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuTrigUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuTrigUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuTrigDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuTrigDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuResolUp=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuResolUp","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetMuonMass_noLSF_MuResolDown=           m_histoFolder.make<TH1D>("leadAK8JetMuonMass_noLSF_MuResolDown","2 Object Mass of the leading Jet and Muon;Mass (GeV);"                         ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_JECUp  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_JECUp","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_JECDown  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_JECDown","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_JERUp  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_JERUp","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_JERDown  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_JERDown","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_PUUp  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_PUUp","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_PUDown  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_PUDown","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_MuLUp  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_MuLUp","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_MuLDown  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_MuLDown","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_HEEPUp  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_HEEPUp","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_leadAK8JetElectronMass_HEEPDown  =           m_histoFolder.make<TH1D>("leadAK8JetElectronMass_HEEPDown","2 Object Mass of the leading Jet and Electron;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass  =           m_histoFolder.make<TH1D>("resolvedRECOmass","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResIsoUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResIsoUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResIsoDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResIsoDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResIDUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResIDUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResIDDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResIDDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuTrigUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuTrigUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuTrigDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuTrigDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_PUUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_PUUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_PUDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_PUDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResolUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResolUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_MuResolDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_MuResolDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_JECUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_JECUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_JECDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_JECDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_JERUp  =           m_histoFolder.make<TH1D>("resolvedRECOmass_JERUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedRECOmass_JERDown  =           m_histoFolder.make<TH1D>("resolvedRECOmass_JERDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_JECUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_JECUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_JECDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_JECDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_JERUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_JERUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_JERDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_JERDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_PUUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_PUUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_PUDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_PUDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuIDUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuIDUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuIDDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuIDDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuIsoUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuIsoUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuIsoDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuIsoDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_HEEPUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_HEEPUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_HEEPDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_HEEPDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
   m_resolvedFSBRECOmass_MuTrigUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuTrigUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuTrigDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuTrigDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
   m_resolvedFSBRECOmass_MuResolUp  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuResolUp","2 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
    m_resolvedFSBRECOmass_MuResolDown  =           m_histoFolder.make<TH1D>("resolvedFSBRECOmass_MuResolDown","4 Object Mass;Mass (GeV);"                 ,1200, 0, 6000);//11, binBoundaries);
  }
}
...
void eventHistos::fillCombine_MuResIDUp(eventBits& event) {
  ...
  if(event.isMC){
    if(m_FSB == true){
      weight = event.FSBweight*event.Muon_HighPtID_WeightUp*event.Muon_HighPtID2nd_WeightUp/(event.Muon_HighPtID_Weight*event.Muon_HighPtID2nd_Weight);
    }else{
...
void eventHistos::fillCombine_MuResIDDown(eventBits& event) {
  ...
  if(event.isMC){
    if(m_FSB == true){
      weight = event.FSBweight*event.Muon_HighPtID_WeightDown*event.Muon_HighPtID2nd_WeightDown/(event.Muon_HighPtID_Weight*event.Muon_HighPtID2nd_Weight);
    }else{
      weight = event.weight*event.Muon_HighPtID_WeightDown*event.Muon_HighPtID2nd_WeightDown/(event.Muon_HighPtID_Weight*event.Muon_HighPtID2nd_Weight);
    }
  }else{
    weight = 1.;
  }
...
void eventHistos::fillCombine_MuResIsoUp(eventBits& event) {
  double weight = 0.0;
  if(event.isMC){
    if(m_FSB == true){
      weight = event.FSBweight*event.Muon_LooseTkIso_WeightUp*event.Muon_LooseTkIso2nd_WeightUp/(event.Muon_LooseTkIso_Weight*event.Muon_LooseTkIso2nd_Weight);
    }else{
      weight = event.weight*event.Muon_LooseTkIso_WeightUp*event.Muon_LooseTkIso2nd_WeightUp/(event.Muon_LooseTkIso_Weight*event.Muon_LooseTkIso2nd_Weight);
    }
  }else{
    weight = 1.;
  }

  m_resolvedRECOmass_MuResIsoUp->Fill(event.resolvedRECOmass, weight);

}
void eventHistos::fillCombine_MuResIsoDown(eventBits& event) {
  double weight = 0.0;
  if(event.isMC){
    if(m_FSB == true){
      weight = event.FSBweight*event.Muon_LooseTkIso_WeightDown*event.Muon_LooseTkIso2nd_WeightDown/(event.Muon_LooseTkIso_Weight*event.Muon_LooseTkIso2nd_Weight);
    }else{
      weight = event.weight*event.Muon_LooseTkIso_WeightDown*event.Muon_LooseTkIso2nd_WeightDown/(event.Muon_LooseTkIso_Weight*event.Muon_LooseTkIso2nd_Weight);
    }
  }else{
    weight = 1.;
  }

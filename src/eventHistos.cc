...
void eventHistos::book(TFileDirectory histoFolder, uint16_t flavor) {
  ...
  //MAKE GEN PLOTS
    ...
    m_leadAK8JetMuonJetMuonEnergyFraction =   m_histoFolder.make<TH1D>("leadAK8JetMuonJetMuonEnergyFraction", "muon energy fraction of ak8jet in the selected jet muon pair; percent muon energy;", 100, 0.0, 1.0);

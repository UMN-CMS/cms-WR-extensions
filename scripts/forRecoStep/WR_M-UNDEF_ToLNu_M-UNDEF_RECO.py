...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WR_M-2400_ToLNu_M-1200_RAWSIM_13TeV-2016.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_AODSIM_13TeV-2016.root'),

...
if ($#ARGV<1) {
    ...
    print "    --memreq (requested memory in MB)\n";
...
if ($nosubmit) {
    open(SUBMIT,">condor_submit_$jobBase.txt");
} else {
    open(SUBMIT,"|condor_submit_$jobBase");
}
...
print(SUBMIT "request_memory = $mem_request\n");

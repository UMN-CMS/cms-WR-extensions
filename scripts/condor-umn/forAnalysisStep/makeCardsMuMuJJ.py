...
def SignalRegionCard(workspaceDirectory):
    ...
    systs = ['JEC','JER','PU']
    sigs = ['5000,1000','5000,500','4500,900','4500,450','4000,800','4000,400','3500,700','3500,350','3000,600','3000,300','2500,500','2500,250','2000,400','2000,200','1500,300','1500,150','1000,200','1000,100']

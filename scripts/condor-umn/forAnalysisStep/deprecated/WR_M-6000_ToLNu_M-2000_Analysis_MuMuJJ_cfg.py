...
process.source = cms.Source ("PoolSource",
	  fileNames = cms.untracked.vstring ("file:WR_6000_ToLNu_MASSNR_MiniAOD_MuMuJJ.root")
      ,
)
...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("WR_6000_ToLNu_2000_Analysis_MuMuJJ.root")
...
process.analyze = cms.EDAnalyzer('cmsWRextension',
                              ...
                              MCL = cms.untracked.double(),
                              MCU = cms.untracked.double()
)

...
process.source = cms.Source ("PoolSource",
	  fileNames = cms.untracked.vstring ("file:WR_3200_ToLNu_MASSNR_MiniAOD_MuMuJJ.root")
      ,
)
...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("WR_3200_ToLNu_1067_Analysis_MuMuJJ.root")
...
process.analyze = cms.EDAnalyzer('cmsWRextension',
                              ...
                              MCL = cms.untracked.double(2240.0),
                              MCU = cms.untracked.double(4160.0)
)

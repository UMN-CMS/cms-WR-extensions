...
process.source = cms.Source ("PoolSource",
	  fileNames = cms.untracked.vstring ("file:WR_800_ToLNu_MASSNR_MiniAOD_MuMuJJ.root")
      ,
)
...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("WR_800_ToLNu_160_Analysis_MuMuJJ.root")
...
process.analyze = cms.EDAnalyzer('cmsWRextension',
                              ...
                              MCL = cms.untracked.double(560.0),
                              MCU = cms.untracked.double(1040.0),

...
def SignalRegionWorkspace(sampleNames,samplesLocation,workspaceOutputDirectory, weights):
...
SignalRegionWorkspace(sampleNames,samplesLocation,workspaceOutputDirectory, weights)

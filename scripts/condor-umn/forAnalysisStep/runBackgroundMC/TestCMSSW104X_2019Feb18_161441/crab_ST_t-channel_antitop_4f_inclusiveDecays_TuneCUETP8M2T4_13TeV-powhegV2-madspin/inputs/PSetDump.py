...
process.heep_modifications = cms.VPSet(
    cms.PSet(
...
process.heepIDVarValueMaps = cms.EDProducer("ElectronHEEPIDValueMapProducer",
    ...
    elesMiniAOD = cms.InputTag("selectedElectrons"),
...
process.patJetsAK8PFPuppi = cms.EDProducer("PATJetProducer",
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAK8PFPuppi")),
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVAK8TagInfosAK8PFPuppi"), cms.InputTag("pfImpactParameterAK8TagInfosAK8PFPuppi"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAK8PFPuppi")),
    ...
    userData = cms.PSet(
        ...
        userFloats = cms.PSet(
            src = cms.VInputTag(
                "", "ak8PFJetsPuppiSoftDropMass", "NjettinessAK8Puppi:tau1", "NjettinessAK8Puppi:tau2", "NjettinessAK8Puppi:tau3", 
...
process.patJetsAK8PFPuppiSoftDropSubjets = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfCombinedCvsLJetTagsAK8PFPuppiSoftDropSubjets"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAK8PFPuppiSoftDropSubjets"), cms.InputTag("pfCombinedCvsBJetTagsAK8PFPuppiSoftDropSubjets")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAK8PFPuppiSoftDropSubjets")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.pfCombinedCvsBJetTagsAK8PFPuppiSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAK8PFPuppiSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAK8PFPuppiSoftDropSubjets"))
)


process.pfCombinedCvsLJetTagsAK8PFPuppiSoftDropSubjets = cms.EDProducer("JetTagProducer",
...
process.pfInclusiveSecondaryVertexFinderCvsLTagInfosAK8PFPuppiSoftDropSubjets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
...
process.slimmedHEEPElectrons = cms.EDProducer("ModifiedElectronProducer",
    modifierConfig = cms.PSet(
        modifications = cms.VPSet(
            cms.PSet(
                electron_config = cms.PSet(
...
process.tuneIDMuons = cms.EDFilter("PATMuonSelector",
    cut = cms.string(' userInt("highPtID") == 1'),
...
process.analysis = cms.EDAnalyzer("cmsWRextension",
    ...
    electronPathsToPass = cms.vstring(
        'HLT_Ele27_WPTight_Gsf_v', 
        'HLT_Ele115_CaloIdVT_GsfTrkIdT_v', 
        'HLT_Photon175_v'
    ),
    electrons2 = cms.InputTag("selectedElectrons"),
    era = cms.untracked.string('2016'),
    ...
    outputTag = cms.untracked.string('applePie'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ST_t-channel_antitop_4f_inclusiveDecays.root')
)
...
process.patAlgosToolsTask = cms.Task(process.NjettinessAK8Puppi, process.ak8GenJetsNoNu, process.ak8GenJetsNoNuSoftDrop, process.ak8PFJetsPuppi, process.ak8PFJetsPuppiConstituents, process.ak8PFJetsPuppiSoftDrop, process.ak8PFJetsPuppiSoftDropMass, process.candidateVertexArbitrator, process.candidateVertexArbitratorCvsL, process.candidateVertexArbitratorDefault, process.candidateVertexMerger, process.candidateVertexMergerCvsL, process.inclusiveCandidateSecondaryVertices, process.inclusiveCandidateSecondaryVerticesCvsL, process.inclusiveCandidateVertexFinder, process.inclusiveCandidateVertexFinderCvsL, process.inclusiveCandidateVertexFinderDefault, process.inclusiveSecondaryVertices, process.inclusiveVertexFinder, process.inclusiveVertexFinderDefault, process.packedGenParticlesForJetsNoNu, process.packedPatJetsAK8PFPuppiSoftDrop, process.patJetCorrFactorsAK8PFPuppi, process.patJetCorrFactorsAK8PFPuppiSoftDrop, process.patJetCorrFactorsAK8PFPuppiSoftDropSubjets, process.patJetFlavourAssociationAK8PFPuppi, process.patJetFlavourAssociationAK8PFPuppiSoftDropSubjets, process.patJetFlavourAssociationLegacyAK8PFPuppi, process.patJetFlavourAssociationLegacyAK8PFPuppiSoftDropSubjets, process.patJetGenJetMatchAK8PFPuppi, process.patJetGenJetMatchAK8PFPuppiSoftDrop, process.patJetGenJetMatchAK8PFPuppiSoftDropSubjets, process.patJetPartonAssociationLegacyAK8PFPuppi, process.patJetPartonAssociationLegacyAK8PFPuppiSoftDropSubjets, process.patJetPartonMatchAK8PFPuppi, process.patJetPartonMatchAK8PFPuppiSoftDrop, process.patJetPartonMatchAK8PFPuppiSoftDropSubjets, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK8PFPuppi, process.patJetsAK8PFPuppiSoftDrop, process.patJetsAK8PFPuppiSoftDropSubjets, process.pfBoostedDoubleSVAK8TagInfosAK8PFPuppi, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAK8PFPuppi, process.pfCombinedCvsBJetTagsAK8PFPuppiSoftDropSubjets, process.pfCombinedCvsLJetTagsAK8PFPuppiSoftDropSubjets, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAK8PFPuppiSoftDropSubjets, process.pfImpactParameterAK8TagInfosAK8PFPuppi, process.pfImpactParameterTagInfosAK8PFPuppiSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAK8PFPuppi, process.pfInclusiveSecondaryVertexFinderCvsLTagInfosAK8PFPuppiSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderTagInfosAK8PFPuppiSoftDropSubjets, process.puppi, process.selectedPatJetsAK8PFPuppi, process.selectedPatJetsAK8PFPuppiSoftDrop, process.selectedPatJetsAK8PFPuppiSoftDropPacked, process.selectedPatJetsAK8PFPuppiSoftDropSubjets, process.slimmedSecondaryVerticesCvsL, process.softPFElectronsTagInfosAK8PFPuppiSoftDropSubjets, process.softPFMuonsTagInfosAK8PFPuppiSoftDropSubjets, process.trackVertexArbitrator, process.trackVertexArbitratorDefault, process.vertexMerger)
...
process.jetSequence = cms.Sequence(process.packedGenParticlesForJetsNoNu+process.ak8GenJetsNoNu+process.puppi+process.ak8PFJetsPuppi+process.ak8PFJetsPuppiConstituents+process.ak8PFJetsPuppiSoftDrop+process.ak8PFJetsPuppiSoftDropMass+process.ak8GenJetsNoNuSoftDrop+process.selectedPatJetsAK8PFPuppiSoftDropPacked+process.packedPatJetsAK8PFPuppiSoftDrop+process.NjettinessAK8Puppi)


process.egmGsfElectronIDSequence = cms.Sequence(cms.Task(process.heepIDVarValueMaps), process.egmGsfElectronIDTask)


process.addHEEPToSlimmedElectrons = cms.Sequence(process.slimmedHEEPElectrons)
...
process.heepSequence = cms.Sequence(process.egmGsfElectronIDSequence+process.addHEEPToHEEPElectrons)


process.totalPath = cms.Path(process.selectedElectrons+process.heepSequence+process.muonSelectionSeq+process.analysis)

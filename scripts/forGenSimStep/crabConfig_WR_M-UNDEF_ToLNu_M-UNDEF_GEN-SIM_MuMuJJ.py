...
config.General.requestName = 'WR_M-UNDEF_ToLNu_M-UNDEF_GEN-SIM_MuMuJJ'  
...
config.JobType.psetName = 'WR_M-UNDEF_ToLNu_M-UNDEF_GEN-SIM_MuMuJJ.py'  

config.section_("Data")
config.Data.outputPrimaryDataset = 'WRToMuMuJJ_MW-UNDEF_MNu-UNDEF_TuneCUETP8M1_13TeV-pythia8'

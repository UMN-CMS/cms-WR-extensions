...
# with command line options: --mc --step PAT --filein=file:WR_M-2400_ToLNu_M-1200_RECO_NEW.root --fileout=file:WR_M-2400_ToLNu_M-1200_miniAOD_NEW.root --python_filename=WR_M-2400_ToLNu_M-1200_miniAOD_EEJJ.py --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions=80X_mcRun2_asymptotic_2016_miniAODv2_v1 --era=Run2_2016 --runUnscheduled --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WR_M-2400_ToLNu_M-1200_AODSIM_13TeV-2016.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WR_M-MASSWR_ToLNu_M-MASSNU_miniAOD_13TeV-2016.root'),

...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WR_ToLNu_ToLLJJ_MNuUndef_4000_13TeV_NNUUMMPU_RAW_RECO.root'),
...
# Other statements
process.mix.input.nbPileupEvents.averageNumber = cms.double(40.0000)

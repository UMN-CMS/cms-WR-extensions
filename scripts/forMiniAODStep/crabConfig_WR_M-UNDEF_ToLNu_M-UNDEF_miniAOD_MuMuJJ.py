...
config.General.requestName = 'WR_M-UNDEF_ToLNu_M-UNDEF_miniAOD_MuMuJJ'  
...
config.JobType.psetName = 'WR_M-UNDEF_ToLNu_M-UNDEF_miniAOD_MuMuJJ.py'  

config.section_("Data")
config.Data.inputDataset = 'datasetFromDBS'
config.Data.inputDBS = 'phys03'
config.Data.ignoreLocality = True
config.Data.outputDatasetTag = 'RunIIWinter16_80X_mcRun2_asymptotic_2016_miniAODv2_v1_MINIAODSIM' 
